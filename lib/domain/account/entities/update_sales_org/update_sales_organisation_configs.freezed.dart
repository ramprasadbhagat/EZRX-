...
part of 'update_sales_organisation_configs.dart';
...
/// @nodoc
mixin _$UpdateSalesOrganisationConfigs {
  ...
  @JsonKey(ignore: true)
  $UpdateSalesOrganisationConfigsCopyWith<UpdateSalesOrganisationConfigs>
      get copyWith => throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $UpdateSalesOrganisationConfigsCopyWith<$Res> {
  factory $UpdateSalesOrganisationConfigsCopyWith(
          UpdateSalesOrganisationConfigs value,
          $Res Function(UpdateSalesOrganisationConfigs) then) =
      _$UpdateSalesOrganisationConfigsCopyWithImpl<$Res,
...
/// @nodoc
class _$UpdateSalesOrganisationConfigsCopyWithImpl<$Res,
        $Val extends UpdateSalesOrganisationConfigs>
    implements $UpdateSalesOrganisationConfigsCopyWith<$Res> {
  _$UpdateSalesOrganisationConfigsCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$UpdateSalesOrganisationConfigsImplCopyWith<$Res>
    implements $UpdateSalesOrganisationConfigsCopyWith<$Res> {
  factory _$$UpdateSalesOrganisationConfigsImplCopyWith(
          _$UpdateSalesOrganisationConfigsImpl value,
          $Res Function(_$UpdateSalesOrganisationConfigsImpl) then) =
      __$$UpdateSalesOrganisationConfigsImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {SalesOrg salesOrg,
...
/// @nodoc
class __$$UpdateSalesOrganisationConfigsImplCopyWithImpl<$Res>
    extends _$UpdateSalesOrganisationConfigsCopyWithImpl<$Res,
        _$UpdateSalesOrganisationConfigsImpl>
    implements _$$UpdateSalesOrganisationConfigsImplCopyWith<$Res> {
  __$$UpdateSalesOrganisationConfigsImplCopyWithImpl(
      _$UpdateSalesOrganisationConfigsImpl _value,
      $Res Function(_$UpdateSalesOrganisationConfigsImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$UpdateSalesOrganisationConfigsImpl(
      salesOrg: null == salesOrg
          ? _value.salesOrg
          : salesOrg // ignore: cast_nullable_to_non_nullable
              as SalesOrg,
...
class _$UpdateSalesOrganisationConfigsImpl
    extends _UpdateSalesOrganisationConfigs {
  const _$UpdateSalesOrganisationConfigsImpl(
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$UpdateSalesOrganisationConfigsImpl &&
            (identical(other.salesOrg, salesOrg) ||
                other.salesOrg == salesOrg) &&
            (identical(other.poNumberRequired, poNumberRequired) ||
                other.poNumberRequired == poNumberRequired) &&
            (identical(other.priceOverride, priceOverride) ||
                other.priceOverride == priceOverride) &&
            (identical(other.expiryDateDisplay, expiryDateDisplay) ||
                other.expiryDateDisplay == expiryDateDisplay) &&
            (identical(other.batchNumDisplay, batchNumDisplay) ||
                other.batchNumDisplay == batchNumDisplay) &&
            ...
            (identical(other.enableZDP8Override, enableZDP8Override) ||
                other.enableZDP8Override == enableZDP8Override) &&
            (identical(other.displayOrderDiscount, displayOrderDiscount) ||
                other.displayOrderDiscount == displayOrderDiscount) &&
            (identical(other.enableIRN, enableIRN) ||
                other.enableIRN == enableIRN) &&
            ...
            (identical(other.hideStockDisplay, hideStockDisplay) ||
                other.hideStockDisplay == hideStockDisplay) &&
            (identical(other.showPOAttachment, showPOAttachment) ||
                other.showPOAttachment == showPOAttachment) &&
            (identical(other.disableDeliveryDate, disableDeliveryDate) ||
                other.disableDeliveryDate == disableDeliveryDate) &&
            ...
            (identical(other.enableGreenDelivery, enableGreenDelivery) ||
                other.enableGreenDelivery == enableGreenDelivery) &&
            (identical(other.greenDeliveryDelayInDays, greenDeliveryDelayInDays) ||
                other.greenDeliveryDelayInDays == greenDeliveryDelayInDays) &&
            (identical(other.greenDeliveryUserRole, greenDeliveryUserRole) ||
                other.greenDeliveryUserRole == greenDeliveryUserRole) &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$UpdateSalesOrganisationConfigsImplCopyWith<
          _$UpdateSalesOrganisationConfigsImpl>
      get copyWith => __$$UpdateSalesOrganisationConfigsImplCopyWithImpl<
          _$UpdateSalesOrganisationConfigsImpl>(this, _$identity);
}

abstract class _UpdateSalesOrganisationConfigs
    extends UpdateSalesOrganisationConfigs {
  const factory _UpdateSalesOrganisationConfigs(
      ...
      required final bool enableGMN}) = _$UpdateSalesOrganisationConfigsImpl;
  const _UpdateSalesOrganisationConfigs._() : super._();
