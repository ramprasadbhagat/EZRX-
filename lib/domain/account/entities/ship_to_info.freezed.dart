...
class _$_ShipToInfo extends _ShipToInfo {
  const _$_ShipToInfo({required this.shipToCustomerCode}) : super._();
  ...
  @override
  String toString() {
    return 'ShipToInfo(shipToCustomerCode: $shipToCustomerCode)';
  }
...
abstract class _ShipToInfo extends ShipToInfo {
  const factory _ShipToInfo({required final String shipToCustomerCode}) =
      _$_ShipToInfo;
