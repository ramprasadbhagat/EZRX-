...
part of 'all_invoices_filter.dart';
...
/// @nodoc
abstract class $AllInvoicesFilterCopyWith<$Res> {
  factory $AllInvoicesFilterCopyWith(
          AllInvoicesFilter value, $Res Function(AllInvoicesFilter) then) =
...
/// @nodoc
class _$AllInvoicesFilterCopyWithImpl<$Res, $Val extends AllInvoicesFilter>
    implements $AllInvoicesFilterCopyWith<$Res> {
  _$AllInvoicesFilterCopyWithImpl(this._value, this._then);
...
class _$_AllInvoicesFilter extends _AllInvoicesFilter {
  ...
  @override
  String toString() {
    return 'AllInvoicesFilter(documentNumber: $documentNumber, dueDateFrom: $dueDateFrom, dueDateTo: $dueDateTo, documentDateFrom: $documentDateFrom, documentDateTo: $documentDateTo, debitValueFrom: $debitValueFrom, debitValueTo: $debitValueTo, filterStatus: $filterStatus)';
  }
