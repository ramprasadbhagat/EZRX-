...
part of 'payment_invoice_info_pdf.dart';
...
mixin _$PaymentInvoiceInfoPdf {
  ...
  @JsonKey(ignore: true)
  $PaymentInvoiceInfoPdfCopyWith<PaymentInvoiceInfoPdf> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $PaymentInvoiceInfoPdfCopyWith<$Res> {
  factory $PaymentInvoiceInfoPdfCopyWith(PaymentInvoiceInfoPdf value,
          $Res Function(PaymentInvoiceInfoPdf) then) =
      _$PaymentInvoiceInfoPdfCopyWithImpl<$Res, PaymentInvoiceInfoPdf>;
  @useResult
  $Res call(
...
/// @nodoc
class _$PaymentInvoiceInfoPdfCopyWithImpl<$Res,
        $Val extends PaymentInvoiceInfoPdf>
    implements $PaymentInvoiceInfoPdfCopyWith<$Res> {
  _$PaymentInvoiceInfoPdfCopyWithImpl(this._value, this._then);
...
class _$_PaymentInvoiceInfoPdf extends _PaymentInvoiceInfoPdf {
  ...
  @override
  final String payer;
  final List<BankBeneficiary> _bankBeneficiary;
  @override
  List<BankBeneficiary> get bankBeneficiary {
...
abstract class _PaymentInvoiceInfoPdf extends PaymentInvoiceInfoPdf {
  const factory _PaymentInvoiceInfoPdf(
