...
mixin _$SavedOrder {
  ...
  List<PoDocuments> get poAttachent => throw _privateConstructorUsedError;
...
/// @nodoc
abstract class _$$_SavedOrderCopyWith<$Res>
    implements $SavedOrderCopyWith<$Res> {
  factory _$$_SavedOrderCopyWith(
...
class _$_SavedOrder extends _SavedOrder {
  const _$_SavedOrder(
      ...
      required final List<PoDocuments> poAttachent})
      : _items = items,
...
abstract class _SavedOrder extends SavedOrder {
  const factory _SavedOrder(
      ...
      required final List<PoDocuments> poAttachent}) = _$_SavedOrder;
