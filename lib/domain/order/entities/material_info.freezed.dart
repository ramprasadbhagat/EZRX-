...
mixin _$MaterialInfo {
  ...
  List<MaterialData> get data => throw _privateConstructorUsedError;
...
abstract class $MaterialInfoCopyWith<$Res> {
  ...
  $Res call(
      ...
      int dataTotalCount,
      DataTotalHidden dataTotalHidden,
      bool isGimmick,
...
class _$_MaterialInfo extends _MaterialInfo {
  ...
  final List<MaterialData> _data;
  @override
  List<MaterialData> get data {
  ...
  @override
  final DataTotalHidden dataTotalHidden;
  @override
...
abstract class _MaterialInfo extends MaterialInfo {
  ...
  @override
  DataTotalHidden get dataTotalHidden;
  @override
  bool get isGimmick;
  @override
  List<StockInfo> get stockInfos;
...
/// @nodoc
mixin _$MaterialResponse {
  int get count => throw _privateConstructorUsedError;
  List<MaterialInfo> get products => throw _privateConstructorUsedError;

  @JsonKey(ignore: true)
  $MaterialResponseCopyWith<MaterialResponse> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $MaterialResponseCopyWith<$Res> {
  factory $MaterialResponseCopyWith(
          MaterialResponse value, $Res Function(MaterialResponse) then) =
      _$MaterialResponseCopyWithImpl<$Res, MaterialResponse>;
  @useResult
  $Res call({int count, List<MaterialInfo> products});
}

/// @nodoc
class _$MaterialResponseCopyWithImpl<$Res, $Val extends MaterialResponse>
    implements $MaterialResponseCopyWith<$Res> {
  _$MaterialResponseCopyWithImpl(this._value, this._then);
...
class _$_MaterialResponse extends _MaterialResponse {
  ...
  @override
  String toString() {
    return 'MaterialResponse(count: $count, products: $products)';
  }
