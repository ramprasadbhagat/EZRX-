...
class _$_MaterialItemBonus extends _MaterialItemBonus {
  ...
  @override
  String toString() {
    return 'MaterialItemBonus(materialInfo: $materialInfo, qty: $qty, comment: $comment, materialDescription: $materialDescription, expiryDate: $expiryDate, inStock: $inStock, remainingQty: $remainingQty, additionalBonusFlag: $additionalBonusFlag, bonusOverrideFlag: $bonusOverrideFlag)';
  }
