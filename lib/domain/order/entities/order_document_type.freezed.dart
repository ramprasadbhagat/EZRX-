...
part of 'order_document_type.dart';
...
mixin _$OrderDocumentType {
  ...
  @JsonKey(ignore: true)
  $OrderDocumentTypeCopyWith<OrderDocumentType> get copyWith =>
...
class _$_OrderDocumentType extends _OrderDocumentType {
  ...
  @override
  String toString() {
    return 'OrderDocumentType(salesOrg: $salesOrg, documentType: $documentType, description: $description, shippingCondition: $shippingCondition, orderReason: $orderReason)';
  }
