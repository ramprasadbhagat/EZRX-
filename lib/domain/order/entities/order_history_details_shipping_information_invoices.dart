...
@freezed
class OrderHistoryDetailsShippingInformationInvoices with _$OrderHistoryDetailsShippingInformationInvoices {
  ...
  factory OrderHistoryDetailsShippingInformationInvoices.empty() => OrderHistoryDetailsShippingInformationInvoices(
        invoiceNumber: '',
        invoiceDate: '',
        invoicePrice: '',
      );
