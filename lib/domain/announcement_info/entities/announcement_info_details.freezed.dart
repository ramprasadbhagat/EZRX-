...
part of 'announcement_info_details.dart';
...
/// @nodoc
abstract class $AnnouncementInfoDetailsCopyWith<$Res> {
  factory $AnnouncementInfoDetailsCopyWith(AnnouncementInfoDetails value,
          $Res Function(AnnouncementInfoDetails) then) =
      _$AnnouncementInfoDetailsCopyWithImpl<$Res, AnnouncementInfoDetails>;
  @useResult
  $Res call(
      {String id,
      String title,
...
/// @nodoc
class _$AnnouncementInfoDetailsCopyWithImpl<$Res,
        $Val extends AnnouncementInfoDetails>
    implements $AnnouncementInfoDetailsCopyWith<$Res> {
  _$AnnouncementInfoDetailsCopyWithImpl(this._value, this._then);
