            ...
            () {
              ...
              showSnackBar(
                ...
                message: state.response.message
                    .getOrDefaultValue('Data Updated Successfully'.tr())
                    .tr(),
              );
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<ManagePaymentAdviceFooterBloc,
      ...
      buildWhen: (previous, current) =>
          ...
          previous.paymentAdviceFooterData.uploadFiles !=
              current.paymentAdviceFooterData.uploadFiles ||
          previous.showErrorMessages != current.showErrorMessages,
      builder: (context, state) {
        ...
        return Column(
          ...
          children: [
            ...
            state.paymentAdviceFooterData.headerTextActive
                ...
                : _UploadFile(
                    files: state.paymentAdviceFooterData.uploadFiles,
                  ),
          ],
        );
      },
