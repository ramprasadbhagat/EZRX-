...
import '../../application/order/material_filter/material_filter_bloc.dart'
    as _i55;
import '../../domain/account/entities/bill_to_info.dart' as _i59;
import '../../domain/account/entities/customer_code_info.dart' as _i60;
import '../../domain/account/entities/sales_organisation_configs.dart' as _i62;
import '../../domain/account/entities/ship_to_info.dart' as _i64;
import '../../domain/account/value/value_objects.dart' as _i54;
import '../../domain/core/aggregate/bundle_aggregate.dart' as _i66;
import '../../domain/core/aggregate/price_aggregate.dart' as _i67;
import '../../domain/order/entities/cart_item.dart' as _i63;
import '../../domain/order/entities/order_history_basic_info.dart' as _i61;
import '../../domain/order/entities/order_history_item.dart' as _i58;
import '../../domain/order/entities/order_template.dart' as _i56;
import '../../domain/order/entities/price_combo_deal.dart' as _i68;
import '../../domain/order/entities/saved_order.dart' as _i57;
import '../../domain/returns/entities/return_summary_requests.dart' as _i65;
...
class EditPaymentMethodsPageRoute
    extends _i52.PageRouteInfo<EditPaymentMethodsPageRouteArgs> {
  EditPaymentMethodsPageRoute({
    _i53.Key? key,
    required _i54.SalesOrg salesOrg,
    required _i54.PaymentMethod oldPaymentMethod,
  }) : super(
          EditPaymentMethodsPageRoute.name,
          path: 'edit_payment_methods',
...
class EditPaymentMethodsPageRouteArgs {
  ...
  final _i54.SalesOrg salesOrg;

  final _i54.PaymentMethod oldPaymentMethod;
...
class MaterialFilterPageRoute
  ...
  MaterialFilterPageRoute({
    _i53.Key? key,
    required _i55.MaterialFilterType filterType,
  }) : super(
          MaterialFilterPageRoute.name,
          path: 'orders/material_filter',
...
class MaterialFilterPageRouteArgs {
  ...
  final _i55.MaterialFilterType filterType;
...
class OrderTemplateDetailPageRoute
  ...
  OrderTemplateDetailPageRoute({
    _i53.Key? key,
    required _i56.OrderTemplate order,
  }) : super(
          OrderTemplateDetailPageRoute.name,
          path: 'orders/order_template_detail',
...
class OrderTemplateDetailPageRouteArgs {
  ...
  final _i56.OrderTemplate order;
...
class SavedOrderDetailPageRoute
  ...
  SavedOrderDetailPageRoute({
    _i53.Key? key,
    required _i57.SavedOrder order,
  }) : super(
          SavedOrderDetailPageRoute.name,
          path: 'orders/saved_order_detail',
...
class HistoryDetailsRoute extends _i52.PageRouteInfo<HistoryDetailsRouteArgs> {
  HistoryDetailsRoute({
    _i53.Key? key,
    required _i58.OrderHistoryItem orderHistoryItem,
    required _i59.BillToInfo billToInfo,
    required _i60.CustomerCodeInfo customerCodeInfo,
    required _i61.OrderHistoryBasicInfo orderHistoryBasicInfo,
    required _i62.SalesOrganisationConfigs salesOrgConfigs,
  }) : super(
          HistoryDetailsRoute.name,
          path: 'orders/history_details',
...
class HistoryDetailsRouteArgs {
  ...
  final _i58.OrderHistoryItem orderHistoryItem;

  final _i59.BillToInfo billToInfo;

  final _i60.CustomerCodeInfo customerCodeInfo;

  final _i61.OrderHistoryBasicInfo orderHistoryBasicInfo;

  final _i62.SalesOrganisationConfigs salesOrgConfigs;
...
class BonusAddPageRoute extends _i52.PageRouteInfo<BonusAddPageRouteArgs> {
  BonusAddPageRoute({
    _i53.Key? key,
    required _i63.CartItem cartItem,
  }) : super(
          BonusAddPageRoute.name,
          path: 'orders/add_bonus',
...
class ReturnSummaryDetailsRoute
  ...
  ReturnSummaryDetailsRoute({
    _i53.Key? key,
    required _i60.CustomerCodeInfo customerCodeInfo,
    required _i64.ShipToInfo shipToInfo,
    required _i65.ReturnSummaryRequest returnSummaryRequests,
  }) : super(
          ReturnSummaryDetailsRoute.name,
          path: 'returns/return_summary_details',
...
class ReturnSummaryDetailsRouteArgs {
  ...
  final _i64.ShipToInfo shipToInfo;

  final _i65.ReturnSummaryRequest returnSummaryRequests;
...
class BundleItemDetailPageRoute
  ...
  BundleItemDetailPageRoute({
    _i53.Key? key,
    required _i66.BundleAggregate bundleAggregate,
  }) : super(
          BundleItemDetailPageRoute.name,
          path: 'orders/bundle_item_detail',
...
class BundleItemDetailPageRouteArgs {
  ...
  final _i66.BundleAggregate bundleAggregate;
...
class ComboDealMaterialDetailPageRoute
  ...
  ComboDealMaterialDetailPageRoute({
    _i53.Key? key,
    required List<_i67.PriceAggregate> comboItems,
    bool isEdit = false,
  }) : super(
          ComboDealMaterialDetailPageRoute.name,
          path: 'orders/combo_deal_material_detail',
...
class ComboDealMaterialDetailPageRouteArgs {
  ...
  final List<_i67.PriceAggregate> comboItems;
...
class ComboDealPrincipleDetailPageRoute
  ...
  ComboDealPrincipleDetailPageRoute({
    _i53.Key? key,
    required _i68.PriceComboDeal comboDeal,
    List<_i67.PriceAggregate> initialComboItems = const [],
  }) : super(
          ComboDealPrincipleDetailPageRoute.name,
          path: 'orders/combo_deal_principle_detail',
...
class ComboDealPrincipleDetailPageRouteArgs {
  ...
  final _i68.PriceComboDeal comboDeal;

  final List<_i67.PriceAggregate> initialComboItems;
...
class AddToCartRoute extends _i52.PageRouteInfo<AddToCartRouteArgs> {
  AddToCartRoute({
    ...
    required _i67.PriceAggregate material,
...
class AddToCartRouteArgs {
  ...
  final _i67.PriceAggregate material;
