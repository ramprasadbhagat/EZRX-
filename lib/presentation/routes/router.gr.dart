...
import '../../domain/announcement_info/entities/announcement_article_info.dart'
    as _i96;
import '../../domain/core/aggregate/bundle_aggregate.dart' as _i92;
...
import '../../domain/payments/entities/payment_summary_details.dart' as _i90;
...
class AppRouter extends _i87.RootStackRouter {
  ...
  final Map<String, _i87.PageFactory> pagesMap = {
    ...
    ViewByOrderDetailsPageRoute.name: (routeData) {
      ...
      return _i87.MaterialPageX<dynamic>(
        routeData: routeData,
        child: _i57.ViewByOrderDetailsPage(
          key: args.key,
    ...
    ReturnRequestSummaryByItemDetailsRoute.name: (routeData) {
      ...
      return _i87.MaterialPageX<dynamic>(
        routeData: routeData,
        child: _i60.ReturnRequestSummaryByItemDetails(
          key: args.key,
...
/// generated route for
/// [_i32.ProfilePage]
class ProfilePageRoute extends _i87.PageRouteInfo<void> {
...
class PaymentSummaryDetailsPageRoute
  ...
  PaymentSummaryDetailsPageRoute({
    _i88.Key? key,
    required _i90.PaymentSummaryDetails paymentSummaryDetails,
  }) : super(
          PaymentSummaryDetailsPageRoute.name,
          path: 'payments/payment_summary/payment_summary_details',
...
class PaymentSummaryDetailsPageRouteArgs {
  ...
  final _i90.PaymentSummaryDetails paymentSummaryDetails;
...
class StatementAccountsPageRoute
    extends _i87.PageRouteInfo<StatementAccountsPageRouteArgs> {
  StatementAccountsPageRoute({_i88.Key? key})
      : super(
          StatementAccountsPageRoute.name,
          path: 'payments/statement_accounts',
...
class BundleItemDetailPageRoute
  ...
  BundleItemDetailPageRoute({
    _i88.Key? key,
    required _i92.BundleAggregate bundleAggregate,
  }) : super(
          BundleItemDetailPageRoute.name,
          path: 'orders/bundle_item_detail',
...
class BundleItemDetailPageRouteArgs {
  ...
  final _i92.BundleAggregate bundleAggregate;
...
class ViewByItemDetailsPageRoute extends _i87.PageRouteInfo<void> {
...
class ViewByOrderDetailsPageRoute
  ...
  ViewByOrderDetailsPageRoute({
    _i88.Key? key,
    required _i94.OrderHistoryDetailsOrderHeader viewByOrdersItem,
  }) : super(
          ViewByOrderDetailsPageRoute.name,
          path: 'orders/view_by_order_details_page',
...
class ViewByOrderDetailsPageRouteArgs {
  ...
  final _i94.OrderHistoryDetailsOrderHeader viewByOrdersItem;
...
/// generated route for
/// [_i65.FAQPage]
class FAQPageRoute extends _i87.PageRouteInfo<void> {
  const FAQPageRoute()
      : super(
          FAQPageRoute.name,
          path: 'faq_page',
...
class NewRequestSuccessfulPageRoute extends _i87.PageRouteInfo<void> {
