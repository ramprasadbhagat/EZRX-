...
import '../payments/invoice_details/invoice_details.dart' as _i39;
...
import '../payments/payment_summary/payment_summary.dart' as _i35;
...
import '../returns/return_list/return_root.dart' as _i34;
...
class AppRouter extends _i76.RootStackRouter {
  ...
  final Map<String, _i76.PageFactory> pagesMap = {
    ...
    AllCreditsPageRoute.name: (routeData) {
      return _i76.MaterialPageX<dynamic>(
        routeData: routeData,
        child: const _i40.AllCreditsPage(),
      );
    },
...
class ViewByOrderDetailsPageRoute
    extends _i76.PageRouteInfo<ViewByOrderDetailsPageRouteArgs> {
  ViewByOrderDetailsPageRoute({
    _i77.Key? key,
    required _i87.OrderHistoryDetailsOrderHeader viewByOrderHistoryItem,
  }) : super(
          ViewByOrderDetailsPageRoute.name,
          path: 'orders/view_by_order_details_page',
...
class ViewByOrderDetailsPageRouteArgs {
  ...
  final _i87.OrderHistoryDetailsOrderHeader viewByOrderHistoryItem;
...
class ViewByOrdersPageRoute
    extends _i76.PageRouteInfo<ViewByOrdersPageRouteArgs> {
