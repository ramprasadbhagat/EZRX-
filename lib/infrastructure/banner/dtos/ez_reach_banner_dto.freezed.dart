...
mixin _$EZReachBannerDto {
  ...
  @JsonKey(ignore: true)
  $EZReachBannerDtoCopyWith<EZReachBannerDto> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $EZReachBannerDtoCopyWith<$Res> {
  factory $EZReachBannerDtoCopyWith(
          EZReachBannerDto value, $Res Function(EZReachBannerDto) then) =
  ...
  $Res call(
      ...
      @HiveField(3)
      String tabBannerUrl,
      @JsonKey(name: 'endDate', defaultValue: '') @HiveField(4) String endDate,
      @JsonKey(name: 'websiteUrl', defaultValue: '')
      @HiveField(5)
      ...
      @HiveField(7)
      bool salesRep,
      @JsonKey(name: 'status', defaultValue: '') @HiveField(8) String status,
      @JsonKey(name: 'customers', defaultValue: false)
      @HiveField(9)
      bool customers,
      @JsonKey(name: 'companyName', defaultValue: '')
      ...
      @JsonKey(name: 'keyWord', defaultValue: '') @HiveField(12) String keyWord,
      @JsonKey(name: 'bannerCampaignLocations', defaultValue: <String>[])
      @HiveField(13)
...
/// @nodoc
class _$EZReachBannerDtoCopyWithImpl<$Res, $Val extends EZReachBannerDto>
    implements $EZReachBannerDtoCopyWith<$Res> {
  _$EZReachBannerDtoCopyWithImpl(this._value, this._then);
    ...
    return _then(_value.copyWith(
      bannerId: null == bannerId
          ...
          : bannerId // ignore: cast_nullable_to_non_nullable
              as String,
      bannerCampaignName: null == bannerCampaignName
          ? _value.bannerCampaignName
          : bannerCampaignName // ignore: cast_nullable_to_non_nullable
              as String,
      ...
      bannerCountId: null == bannerCountId
          ...
          : bannerCountId // ignore: cast_nullable_to_non_nullable
              as int,
      salesRep: null == salesRep
          ? _value.salesRep
          : salesRep // ignore: cast_nullable_to_non_nullable
              as bool,
      status: null == status
          ? _value.status
      ...
      keyWord: null == keyWord
          ...
          : keyWord // ignore: cast_nullable_to_non_nullable
              as String,
      bannerCampaignLocations: null == bannerCampaignLocations
          ? _value.bannerCampaignLocations
          : bannerCampaignLocations // ignore: cast_nullable_to_non_nullable
              as List<String>,
    ...
    return _then(_$_EZReachBannerDto(
      ...
      keyWord: null == keyWord
          ...
          : keyWord // ignore: cast_nullable_to_non_nullable
              as String,
      bannerCampaignLocations: null == bannerCampaignLocations
          ? _value._bannerCampaignLocations
          : bannerCampaignLocations // ignore: cast_nullable_to_non_nullable
              as List<String>,
      salesOrg: null == salesOrg
          ? _value._salesOrg
...
class _$_EZReachBannerDto extends _EZReachBannerDto {
  ...
  List<String> get bannerCampaignLocations {
    if (_bannerCampaignLocations is EqualUnmodifiableListView)
      return _bannerCampaignLocations;
    // ignore: implicit_dynamic_type
    return EqualUnmodifiableListView(_bannerCampaignLocations);
  }
