...
CreditAndInvoiceItemDto _$CreditAndInvoiceItemDtoFromJson(
  ...
  return _CreditAndInvoiceItemDto.fromJson(json);
}
...
mixin _$CreditAndInvoiceItemDto {
  ...
  @JsonKey(ignore: true)
  $CreditAndInvoiceItemDtoCopyWith<CreditAndInvoiceItemDto> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $CreditAndInvoiceItemDtoCopyWith<$Res> {
  factory $CreditAndInvoiceItemDtoCopyWith(CreditAndInvoiceItemDto value,
          $Res Function(CreditAndInvoiceItemDto) then) =
      _$CreditAndInvoiceItemDtoCopyWithImpl<$Res, CreditAndInvoiceItemDto>;
  @useResult
  $Res call(
      {@JsonKey(name: 'bpCustomerNumber', defaultValue: '')
...
/// @nodoc
class _$CreditAndInvoiceItemDtoCopyWithImpl<$Res,
        $Val extends CreditAndInvoiceItemDto>
    implements $CreditAndInvoiceItemDtoCopyWith<$Res> {
  _$CreditAndInvoiceItemDtoCopyWithImpl(this._value, this._then);
