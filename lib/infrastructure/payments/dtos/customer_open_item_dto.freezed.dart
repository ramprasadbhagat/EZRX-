...
mixin _$CustomerOpenItemDto {
  ...
  @JsonKey(ignore: true)
  $CustomerOpenItemDtoCopyWith<CustomerOpenItemDto> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $CustomerOpenItemDtoCopyWith<$Res> {
  factory $CustomerOpenItemDtoCopyWith(
          CustomerOpenItemDto value, $Res Function(CustomerOpenItemDto) then) =
...
/// @nodoc
class _$CustomerOpenItemDtoCopyWithImpl<$Res, $Val extends CustomerOpenItemDto>
    implements $CustomerOpenItemDtoCopyWith<$Res> {
  _$CustomerOpenItemDtoCopyWithImpl(this._value, this._then);
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.totalAmountInDisplayCrcy, totalAmountInDisplayCrcy) ||
