...
UpdateSalesOrganisationConfigsDto _$UpdateSalesOrganisationConfigsDtoFromJson(
  ...
  return _UpdateSalesOrganisationConfigsDto.fromJson(json);
}

/// @nodoc
mixin _$UpdateSalesOrganisationConfigsDto {
  ...
  @JsonKey(ignore: true)
  $UpdateSalesOrganisationConfigsDtoCopyWith<UpdateSalesOrganisationConfigsDto>
      get copyWith => throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $UpdateSalesOrganisationConfigsDtoCopyWith<$Res> {
  factory $UpdateSalesOrganisationConfigsDtoCopyWith(
          UpdateSalesOrganisationConfigsDto value,
          $Res Function(UpdateSalesOrganisationConfigsDto) then) =
      _$UpdateSalesOrganisationConfigsDtoCopyWithImpl<$Res,
          UpdateSalesOrganisationConfigsDto>;
  @useResult
  $Res call(
      ...
      @JsonKey(name: 'languageValue', defaultValue: '') String languageValue,
      @JsonKey(name: 'materialWithoutPrice', defaultValue: false)
...
/// @nodoc
class _$UpdateSalesOrganisationConfigsDtoCopyWithImpl<$Res,
        $Val extends UpdateSalesOrganisationConfigsDto>
    implements $UpdateSalesOrganisationConfigsDtoCopyWith<$Res> {
  _$UpdateSalesOrganisationConfigsDtoCopyWithImpl(this._value, this._then);
...
abstract class _UpdateSalesOrganisationConfigsDto
    extends UpdateSalesOrganisationConfigsDto {
  const factory _UpdateSalesOrganisationConfigsDto(
      {@JsonKey(name: 'salesOrgCode', defaultValue: '0')
