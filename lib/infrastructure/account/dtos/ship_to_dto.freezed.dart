...
mixin _$ShipToDto {
  ...
  String get customerBlock => throw _privateConstructorUsedError;

  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;
  @JsonKey(ignore: true)
  $ShipToDtoCopyWith<ShipToDto> get copyWith =>
...
abstract class $ShipToDtoCopyWith<$Res> {
  ...
  $Res call(
      ...
      @JsonKey(name: 'customerBlock', defaultValue: '') String customerBlock});
}
...
class _$_ShipToDto extends _ShipToDto {
  ...
  List<LicenseDto> get licenseDtoList {
    if (_licenseDtoList is EqualUnmodifiableListView) return _licenseDtoList;
