...
_$_SalesDistrictDto _$$_SalesDistrictDtoFromJson(Map<String, dynamic> json) =>
    _$_SalesDistrictDto(
      ...
      salesDistrictDetails: (json['salesDistricts'] as List<dynamic>)
          .map((e) =>
              SalesDistrictDetailsDto.fromJson(e as Map<String, dynamic>))
          .toList(),
    );
...
Map<String, dynamic> _$$_SalesDistrictDtoToJson(_$_SalesDistrictDto instance) =>
    <String, dynamic>{
      ...
      'salesDistricts':
          instance.salesDistrictDetails.map((e) => e.toJson()).toList(),
    };
