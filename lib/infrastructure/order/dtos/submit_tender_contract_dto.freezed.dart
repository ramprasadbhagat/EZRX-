...
/// @nodoc
abstract class _$$_SubmitTenderContractDtoCopyWith<$Res>
    implements $SubmitTenderContractDtoCopyWith<$Res> {
  factory _$$_SubmitTenderContractDtoCopyWith(_$_SubmitTenderContractDto value,
          $Res Function(_$_SubmitTenderContractDto) then) =
      __$$_SubmitTenderContractDtoCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {@JsonKey(name: 'contractNumber', defaultValue: '')
...
/// @nodoc
class __$$_SubmitTenderContractDtoCopyWithImpl<$Res>
    extends _$SubmitTenderContractDtoCopyWithImpl<$Res,
        _$_SubmitTenderContractDto>
    implements _$$_SubmitTenderContractDtoCopyWith<$Res> {
  __$$_SubmitTenderContractDtoCopyWithImpl(_$_SubmitTenderContractDto _value,
      $Res Function(_$_SubmitTenderContractDto) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$_SubmitTenderContractDto(
      contractNumber: null == contractNumber
          ? _value.contractNumber
          : contractNumber // ignore: cast_nullable_to_non_nullable
              as String,
...
/// @nodoc
@JsonSerializable()
class _$_SubmitTenderContractDto extends _SubmitTenderContractDto {
  const _$_SubmitTenderContractDto(
      {@JsonKey(name: 'contractNumber', defaultValue: '')
  ...
  factory _$_SubmitTenderContractDto.fromJson(Map<String, dynamic> json) =>
      _$$_SubmitTenderContractDtoFromJson(json);
  ...
  @override
  String toString() {
    return 'SubmitTenderContractDto(contractNumber: $contractNumber, contractLineItemNumber: $contractLineItemNumber, contractPrice: $contractPrice, contractPONumber: $contractPONumber, contractUnitOfMeasurement: $contractUnitOfMeasurement, currency: $currency)';
  }
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$_SubmitTenderContractDto &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$_SubmitTenderContractDtoCopyWith<_$_SubmitTenderContractDto>
      get copyWith =>
          __$$_SubmitTenderContractDtoCopyWithImpl<_$_SubmitTenderContractDto>(
              this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$_SubmitTenderContractDtoToJson(
      this,
    );
  }
}
