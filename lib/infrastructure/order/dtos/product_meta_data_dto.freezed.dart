...
class _$_ProductItemDto extends _ProductItemDto {
  ...
  @override
  String toString() {
    return 'ProductItemDto(promotionMaterial: $promotionMaterial, hidePrice: $hidePrice, xp: $xp)';
  }
...
mixin _$ProductItemXpDto {
  ...
  @JsonKey(name: 'Usability', defaultValue: '')
...
class _$_ProductItemXpDto extends _ProductItemXpDto {
  ...
  @override
  String toString() {
    return 'ProductItemXpDto(dosage: $dosage, howToUse: $howToUse, composition: $composition, deliveryInstructions: $deliveryInstructions, usability: $usability)';
  }
...
abstract class _ProductItemXpDto extends ProductItemXpDto {
  const factory _ProductItemXpDto(
      ...
      @JsonKey(name: 'Usability', defaultValue: '')
          required final String usability}) = _$_ProductItemXpDto;
