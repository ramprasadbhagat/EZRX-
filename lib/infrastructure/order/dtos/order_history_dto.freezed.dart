...
class __$$_OrderHistoryDtoCopyWithImpl<$Res>
  ...
  __$$_OrderHistoryDtoCopyWithImpl(
      ...
      : super(_value, (v) => _then(v as _$_OrderHistoryDto));

  @override
  _$_OrderHistoryDto get _value => super._value as _$_OrderHistoryDto;
...
abstract class _OrderHistoryDto extends OrderHistoryDto {
  const factory _OrderHistoryDto(
      ...
      @JsonKey(name: 'PurchaseOrderType')
          required final String purchaseOrderType}) = _$_OrderHistoryDto;
