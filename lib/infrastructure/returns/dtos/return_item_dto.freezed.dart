...
mixin _$ReturnItemDto {
  ...
  @JsonKey(name: 'poMethod', defaultValue: '')
  ...
  List<ReturnScheduleDto> get schedules => throw _privateConstructorUsedError;
  ...
  String get balanceValue => throw _privateConstructorUsedError;
...
abstract class $ReturnItemDtoCopyWith<$Res> {
  ...
  $Res call(
      ...
      @JsonKey(name: 'schedules', defaultValue: <ReturnScheduleDto>[])
          List<ReturnScheduleDto> schedules,
      @JsonKey(name: 'suggestedPriceOverride', defaultValue: '')
...
class _$_ReturnItemDto extends _ReturnItemDto {
  const _$_ReturnItemDto(
      ...
      @JsonKey(name: 'schedules', defaultValue: <ReturnScheduleDto>[])
          required final List<ReturnScheduleDto> schedules,
      @JsonKey(name: 'suggestedPriceOverride', defaultValue: '')
  ...
  final List<ReturnScheduleDto> _schedules;
  @override
  @JsonKey(name: 'schedules', defaultValue: <ReturnScheduleDto>[])
  List<ReturnScheduleDto> get schedules {
  ...
  @override
  String toString() {
    return 'ReturnItemDto(assignmentNumber: $assignmentNumber, referenceDocument: $referenceDocument, purchaseNumberC: $purchaseNumberC, poMethod: $poMethod, createdDate: $createdDate, currency: $currency, plant: $plant, materialNumber: $materialNumber, materialDescription: $materialDescription, itemNumber: $itemNumber, targetQuantity: $targetQuantity, storeLocation: $storeLocation, batch: $batch, highLevelItemCode: $highLevelItemCode, orderReason: $orderReason, priceDate: $priceDate, unitPrice: $unitPrice, totalPrice: $totalPrice, principalCode: $principalCode, principalName: $principalName, expiryDate: $expiryDate, eligibleForReturn: $eligibleForReturn, schedules: $schedules, suggestedPriceOverride: $suggestedPriceOverride, balanceQuantity: $balanceQuantity, balanceValue: $balanceValue, outsidePolicy: $outsidePolicy)';
  }
...
abstract class _ReturnItemDto extends ReturnItemDto {
  const factory _ReturnItemDto(
      ...
      @JsonKey(name: 'balanceValue', defaultValue: '')
          required final String balanceValue,
      @JsonKey(name: 'outsidePolicy', defaultValue: false)
          required final bool outsidePolicy}) = _$_ReturnItemDto;
