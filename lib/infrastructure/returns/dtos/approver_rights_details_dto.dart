...
class ApproverRightsDetailsDto with _$ApproverRightsDetailsDto {
  ...
  const factory ApproverRightsDetailsDto({
    ...
    @JsonKey(name: 'industryCode1', defaultValue: '') required String industryCode1,
    @JsonKey(name: 'industryCode2', defaultValue: '') required String industryCode2,
    @JsonKey(name: 'industryCode3', defaultValue: '') required String industryCode3,
    @JsonKey(name: 'industryCode4', defaultValue: '') required String industryCode4,
