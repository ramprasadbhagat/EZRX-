...
class PointWithUnit implements Serializable {
  ...
  static PointWithUnit get zero =>
      PointWithUnit(DoubleWithUnit.zero, DoubleWithUnit.zero);

  const PointWithUnit(this.x, this.y);

  PointWithUnit.fromJSON(Map<String, dynamic> json)
      : this(
          DoubleWithUnit.fromJSON(json['x'] as Map<String, dynamic>),
...
class DoubleWithUnit implements Serializable {
  ...
  static DoubleWithUnit get zero =>
      const DoubleWithUnit(0.0, MeasureUnit.fraction);
  ...
  DoubleWithUnit.fromJSON(Map<String, dynamic> json)
      : this(
          (json.containsKey('value')
                  ? json['value'] as num
                  : throw ArgumentError('json does not containe value'))
              .toDouble(),
...
class Point implements Serializable {
  ...
  Point.fromJSON(Map<String, dynamic> json)
      : this((json['x'] as num).toDouble(), (json['y'] as num).toDouble());
...
class SizeWithUnitAndAspect implements Serializable {
  ...
  SizeWithAspect? get shorterDimensionAndAspectRatio =>
      _shorterDimensionAndAspectRatio;
  ...
  SizeWithUnitAndAspect.shorterDimensionAndAspectRatio(
    ...
    _shorterDimensionAndAspectRatio = SizeWithAspect(
      DoubleWithUnit(fraction, MeasureUnit.fraction),
      aspectRatio,
    );
  }
  ...
  factory SizeWithUnitAndAspect.fromJSON(Map<String, dynamic> json) {
    if (json.containsKey('width') && json.containsKey('height')) {
      ...
      return SizeWithUnitAndAspect.widthAndAspectRatio(
        DoubleWithUnit.fromJSON(json['width']),
      ...
      return SizeWithUnitAndAspect.heightAndAspectRatio(
        DoubleWithUnit.fromJSON(json['height']),
        (json['aspect'] as num).toDouble(),
      );
    } else if (json.containsKey('shorterDimension') &&
        json.containsKey('aspect')) {
      return SizeWithUnitAndAspect.shorterDimensionAndAspectRatio(
        (json['shorterDimension']['value'] as num).toDouble(),
        (json['aspect'] as num).toDouble(),
      );
    }
    throw Exception(
      'Unable to create an instance of SizeWithUnitAndAspect from the given json',
    );
  }
  ...
  Map<String, dynamic> toMap() {
    if (_widthAndAspectRatio != null) {
      return {
        'width': _widthAndAspectRatio?.size.toMap(),
        'aspect': _widthAndAspectRatio?.aspect,
      };
    }
    if (_heightAndAspectRatio != null) {
      return {
        'height': _heightAndAspectRatio?.size.toMap(),
        'aspect': _heightAndAspectRatio?.aspect,
      };
    }
    if (_shorterDimensionAndAspectRatio != null) {
      return {
...
class SizeWithAspect implements Serializable {
  ...
  SizeWithAspect.fromJSON(Map<String, dynamic> json)
      : this(
          DoubleWithUnit.fromJSON(json['size']),
          (json['aspect'] as num).toDouble(),
        );
...
class Brush implements Serializable {
  ...
  const Brush(this._fillColor, this._strokeColor, this._strokeWidth);

  static Brush get transparent => const Brush(_transparent, _transparent, 0);
