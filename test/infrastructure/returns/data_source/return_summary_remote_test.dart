...
class ReturnSummaryRequestByUserMock extends Mock
    implements ReturnSummaryRequestByUser {}
...
void main() {
  ...
  group(
    'Return Summary Remote Data Test',
    () {
      test('=> getReturnSummaryRequestByUser with status code 200', () async {
        final res = json.decode(
          await rootBundle
              .loadString('assets/json/requestsByUserV2Response.json'),
        );

        final data = jsonEncode({
          'query': remoteDataSource.returnSummaryQueryMutation
              .getrequestsByUserV2Query(),
          'variables': {
            'request': {
              'soldTo': 'mock_soldTo',
              'shipTo': 'mock_shipTo',
