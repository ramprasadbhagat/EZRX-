...
void main() {
  ...
  final fakeUpdatedSavedOrder = SavedOrder.empty().copyWith(
    ...
    billingDocument: fakeCustomerCodeInfo.customerName.name1,
    salesOrganization: fakeSalesOrganisation.salesOrg.getOrCrash(),
    principal: '',
    soldToParty: SoldToParty(fakeCustomerCodeInfo.customerCodeSoldTo),
    ...
    phonenumber: '',
    user: fakeClientUser.id,
    contactPerson: fakeClientUser.fullName.toString(),
    referenceNotes: '',
    items: [],
    poAttachent: [],
  );
  ...
  group('OrderRepository should - ', () {
    ...
    test('get OrderRepository fail locally ', () async {
      ...
      final result = await orderRepository.getSavedOrder(
        ...
        salesOrg: fakeSalesOrganisation,
        customerCode: fakeCustomerCodeInfo,
        shipToCode: ShipToInfo.empty().copyWith(
          ...
          shipToAddress: ShipToAddress.empty()
              .copyWith(street: 'new town', street2: 'new twon'),
        ),
        pageSize: 10,
        offset: 0,
      );
    ...
    test('get OrderRepository successfully remote ', () async {
      ...
      final result = await orderRepository.getSavedOrder(
        ...
        salesOrg: fakeSalesOrganisation.copyWith(salesOrg: SalesOrg('2601')),
    ...
    test('createDraftOrder  successfully locally ', () async {
      ...
      final user = fakeClientUser.copyWith(
        id: '123456',
    ...
    test('createDraftOrder  successfully locally with green delivery',
        () async {
      when(() => mockConfig.appFlavor).thenReturn(Flavor.mock);
      ...
      final result = await orderRepository.createDraftOrder(
        ...
        customerCodeInfo: fakeCustomerCodeInfo,
        salesOrganisation: fakeSalesOrganisation,
        data: deliveryInfoData.copyWith(greenDeliveryEnabled: true),
      );
    ...
    test('createDraftOrder  fail remote ', () async {
      ...
      final draftOrder = SavedOrder.empty().copyWith(
        ...
        specialInstructions: deliveryInfoData.deliveryInstruction.getValue(),
        poReference: deliveryInfoData.poReference.getValue(),
        payTerm: deliveryInfoData.paymentTerm.getValue(),
        totalOrderValue: 100.0,
        draftorder: true,
        address1: mockShipToInfo.shipToAddress.street,
        address2: mockShipToInfo.shipToAddress.street2,
        city: mockShipToInfo.city1,
        phonenumber: deliveryInfoData.mobileNumber.getValue(),
        user: fakeClientUser.id,
        contactPerson: deliveryInfoData.contactPerson.getValue().isNotEmpty
            ? deliveryInfoData.contactPerson.getValue()
            : fakeClientUser.fullName.toString(),
        referenceNotes: deliveryInfoData.referenceNote.getValue(),
        items: getItemList([
