...
void main() {
  ...
  group('Customer Payment Info dto ', () {
    ...
    test(
        'CustomerPaymentInfoDto fromJson and toDomain on TH market match regex form action',
        () {
      final customerPaymentInfoDto =
    ...
    test(
        'CustomerPaymentInfoDto fromJson and toDomain on TH not match Regex form action',
        () {
