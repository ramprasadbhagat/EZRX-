...
class MockReturnSummaryDetailsRepository extends Mock implements ReturnSummaryDetailsRepository{}
...
void main(){
  ...
  group('Return Summary Details Test', () {
    ...
    blocTest(
      'Initialize',
      build: () => ReturnSummaryDetailsBloc(returnSummaryDetailsRepository: mockReturnSummaryDetailsRepository),
      act: (ReturnSummaryDetailsBloc bloc) => bloc.add(const ReturnSummaryDetailsEvent.initialized()),
    ...
    blocTest(
      ...
      setUp: () {
        when(() => mockReturnSummaryDetailsRepository.getReturnInformation(
         returnRequestId: ReturnRequestsId(requestId: 'mock_id')
            ...
            RequestInformation(requestHeader: ReturnRequestInformationHeader.empty(),requestInformation: []),
        ));
      },
      act: (ReturnSummaryDetailsBloc bloc) => bloc.add(ReturnSummaryDetailsEvent.fetch(
      ...
      expect: () => [
        ...
        ReturnSummaryDetailsState.initial().copyWith(
          isLoading: false,
          requestInformation: RequestInformation(requestHeader: ReturnRequestInformationHeader.empty(), requestInformation: []),
        ),
      ],
    );
