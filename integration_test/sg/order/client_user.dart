...
void main() {
  ...
  group('end-to-end test', () {
    testWidgets('Client user SG regression Test', (WidgetTester tester) async {
      ...
      final intergrationTestHelper = IntergrationTestHelper(tester: tester);
      await tester.pump();
      await tester.pump(const Duration(seconds: 5));
      ...
      await intergrationTestHelper.loginTest(
          username: 'sgclientuser', password: 'St@ysafe01');
      ...
      final materialBundleOption =
          find.byKey(const Key('materialBundleOption0008896426'));
      ...
      expect(find.byKey(const Key('materialOption000000000023007533')),
          findsOneWidget);
      expect(find.byKey(const Key('materialOption000000000023007532')),
          findsOneWidget);
      expect(find.byKey(const Key('materialOption000000000023007529')),
          findsOneWidget);

      //add quantity
      final addQunatityFirstItem =
          find.byKey(const Key('bundleAdd000000000023007533'));
      ...
      final changeQunatitySecondItem =
          find.byKey(const Key('bundleText000000000023007532'));
      expect(changeQunatitySecondItem, findsOneWidget);
      await tester.enterText(changeQunatitySecondItem, '5');
      await tester.pump(const Duration(seconds: 2));

      //add quantity
      final addQunatityThirdItem =
          find.byKey(const Key('bundleAdd000000000023007529'));
      expect(addQunatityThirdItem, findsOneWidget);
      await tester.tap(addQunatityThirdItem);
      await tester.pump(const Duration(seconds: 3));

      //deduct changeQunatitySecondItem
      await tester.tap(find.byKey(const Key('bundleDelete000000000023007532')));
      await tester.pump(const Duration(seconds: 3));
      ...
      //expiry date check
      expect(find.byKey(const Key('expiryDate000000000023007533')),
          findsOneWidget);
      expect(find.byKey(const Key('expiryDate000000000023007532')),
          findsOneWidget);
      expect(find.byKey(const Key('expiryDate000000000023007529')),
          findsOneWidget);
      ...
      expect(find.byKey(const Key('bundleCartItem0008896426')), findsOneWidget);
      ...
      //disable gst and Enable VAT At Total Level Only enabled so it will hide
      ...
      await tester.enterText(addBonusTextField, 'mat');
      await tester.pump(const Duration(seconds: 1));
      await tester.testTextInput.receiveAction(TextInputAction.done);
      await tester.pump(const Duration(seconds: 20));

      expect(find.byKey(const Key('addBonusTextFieldmat')), findsOneWidget);
      ...
      await tester.tap(find.byKey(const Key('cartAdd000000000023007533')));
      await tester.pump(const Duration(seconds: 10));
      await tester.tap(find.byKey(const Key('cartDelete000000000023007532')));
      await tester.pump(const Duration(seconds: 10));
      await tester.enterText(
          find.byKey(const Key('cartItem000000000023007529')), '5');
      await tester.pump(const Duration(seconds: 10));
      ...
      expect(materialSearchField, findsOneWidget);
      await tester.enterText(materialSearchField, '21022175');
      await tester.pump(const Duration(seconds: 1));
      await tester.testTextInput.receiveAction(TextInputAction.done);
      await tester.pump(const Duration(seconds: 10));

      expect(find.byKey(const Key('materialOption000000000021022175')),
          findsOneWidget);
      ...
      await tester
          .tap(find.byKey(const Key('materialOption000000000021022175')));
      await tester.pump(const Duration(seconds: 3));
      ...
      await tester.enterText(
          find.byKey(const Key('cartItem000000000021022175')), '2');
      await tester.pump(const Duration(seconds: 5));

      final priceOverrideNew =
          find.byKey(const Key('priceOverride000000000021022175'));
      expect(priceOverrideNew, findsOneWidget);
      await tester.tap(priceOverrideNew);
      await tester.pump(const Duration(seconds: 2));

      await tester.enterText(
          find.byKey(const Key('priceOverrideTextFormField')), '460.596');
      await tester.pump(const Duration(seconds: 2));
      ...
      //try to add covid 19 material
      final covidMaterialTab = find.byKey(const Key('covid-19'));
      expect(covidMaterialTab, findsOneWidget);
      await tester.tap(covidMaterialTab);
      await tester.pump(const Duration(seconds: 2));

      //todo : 7. search textfield of covid-19 tab is not working properly, at the time of onfield submit.

      expect(find.byKey(const Key('covidmaterialListPage')), findsOneWidget);

      final covidMaterial =
          find.byKey(const Key('covidMaterialOption000000000023348698'));
      expect(covidMaterial, findsOneWidget);
      ...
      final materialCartItemNew =
          find.byKey(const Key('materialCartItem000000000021022175'));
      ...
      expect(submitOrderNew, findsOneWidget);
      await tester.tap(submitOrderNew);
      await tester.pump(const Duration(seconds: 5));
      ...
      final orderHistoryItem =
          find.byKey(const Key('materialId000000000021022175'));
      ...
      //enable Discount in Order Details
      expect(find.byKey(const Key('discountRateForItemCard')), findsWidgets);

      //enable Order History Price
      expect(find.byKey(const Key('zpPrice000000000021022175')), findsWidgets);
      ...
      await tester.enterText(filterMaterialSearchField, '21022175');
      await tester.pump(const Duration(seconds: 3));
      ...
      final checkboxListTileFailed =
          find.byKey(const Key('checkboxListTileFailed'));
      expect(checkboxListTileFailed, findsOneWidget);
      await tester.tap(checkboxListTileFailed);
      await tester.pump(const Duration(seconds: 2));
      ...
      final deleteFavouriteFav =
          find.byKey(const Key('deleteFavouriteFavPage000000000021022175'));
      ...
      final covidMaterialNew =
          find.byKey(const Key('covidMaterialOption000000000023348698'));
      expect(covidMaterialNew, findsOneWidget);
      await tester.tap(covidMaterialNew);
      await tester.pump(const Duration(seconds: 5));
      ...
      final deleteFromCartCovidMaterial =
          find.byKey(const Key('deleteFromCart'));
      expect(deleteFromCartCovidMaterial, findsOneWidget);
      await tester.tap(deleteFromCartCovidMaterial);
      await tester.pump(const Duration(seconds: 3));
