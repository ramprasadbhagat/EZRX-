...
void main() {
  ...
  testWidgets('E2E Client User (PH Market) - Order', (tester) async {
    ...
    const phClientUserName = 'phclientuser';
    const phClientPassWord = 'St@ysafe01';
    const salesOrg = '2500';
    ...
    const bonusMaterialAbsolute = '23001545';
    const bonusMaterial1 = '000000000023001545';
    const bonusMaterial2 = '000000000011002989';
    const currency = 'PHP';
    ...
    const clientUserFullName = 'PH ClientUser';
    ...
    await loginRobot.login(phClientUserName, phClientPassWord);
    ...
    await materialListRobot.tapMaterial(bonusMaterial2);
    ...
    //cart page
    cartRobot.verify();
    cartRobot.findMaterialItem(bonusMaterial2, 8);
    cartRobot.findAddQuantity(bonusMaterial2);
    await cartRobot.changeQuantity(bonusMaterial2, 16);
    await cartRobot.getKeyboardDown();
    cartRobot.findMaterialItem(bonusMaterial2, 16);
    cartRobot.verifyBonusMaterial(bonusMaterial2, false, 2);
    await cartRobot.deleteMaterial(bonusMaterial2);
    ...
    await bonusListRobot.tapBonusMaterial(bonusMaterial1);
    await bonusListRobot.changeBonusMaterialQuantity(8);
    ...
    cartRobot.verifyBonusMaterial(bonusMaterial1, true, 8);
