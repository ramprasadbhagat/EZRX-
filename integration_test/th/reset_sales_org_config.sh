...
loginApiResponse=$(curl -s --location 'https://uat-th.ezrxplus.com/api/license' \
...
updateSalesorgconfigMutationReq=$(curl --location 'https://uat-th.ezrxplus.com/api/license' \
--header 'Content-Type: application/json' \
